...
export const ProductCard = ({ product}: Props) =>{
    ...
    return (
        <Link href={`/products/${product.id}`} className="block h-full">
            <Card className="group hover:shadow-2xl transition duration-300 py-0 h-full flex flex-col border-1 border-[#1e2a38] mt-4">
                ...
                <CardHeader className="p-4">
                    ...
                    <Button className="mt-4 bg-orange-500 text-gray-100">View Details</Button>
                    </CardContent>
